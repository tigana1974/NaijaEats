...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Order from chefs, African & Caribbean restaurants, and ethnic groceries. Cooked with culture, delivered fresh." },
      { name: "author", content: "Naija Eats" },
      { property: "og:title", content: "Naija Eats — The Home of African & Authentic Food" },
      { property: "og:description", content: "Order from chefs, African & Caribbean restaurants, and ethnic groceries. Cooked with culture, delivered fresh." },
