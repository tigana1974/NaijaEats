...
const FEATURE_TABLE: { section: string; Icon: React.ComponentType<{ className?: string }>; rows: FeatureRow[] }[] = [
  {
    ...
    rows: [
      { label: "Storefronts", values: { basic: "1", premium: "Up to 5", pro: "Up to 15", enterprise: "Unlimited" } },
      { label: "Featured on Discover", values: { basic: false, premium: "Priority", pro: "Homepage", enterprise: "Always First" } },
      { label: "Custom domain / white-label", values: { basic: false, premium: false, pro: true, enterprise: true } },
      { label: "Menu bulk tools", values: { basic: false, premium: true, pro: true, enterprise: true } },
      { label: "POS & API integrations", values: { basic: false, premium: false, pro: true, enterprise: true } },
    ],
  },
  {
    ...
    rows: [
      { label: "Platform commission", values: { basic: "12%", premium: "8%", pro: "5%", enterprise: "Custom" } },
      { label: "Payout speed", values: { basic: "Weekly", premium: "Daily", pro: "Instant", enterprise: "Instant" } },
      { label: "Wallet payouts", values: { basic: true, premium: true, pro: true, enterprise: true } },
      { label: "Custom pricing plans", values: { basic: false, premium: false, pro: true, enterprise: true } },
    ],
  },
  {
    ...
    rows: [
      { label: "Promo codes & offers", values: { basic: false, premium: true, pro: true, enterprise: true } },
      { label: "Push notifications to fans", values: { basic: false, premium: true, pro: true, enterprise: true } },
      { label: "Managed marketing campaigns", values: { basic: false, premium: false, pro: true, enterprise: true } },
      { label: "Customer insights & CRM", values: { basic: "Basic", premium: "Advanced", pro: "Enterprise", enterprise: "Enterprise+" } },
    ],
  },
  {
    section: "Support",
    ...
    rows: [
      { label: "Support channels", values: { basic: "Email", premium: "Email + Chat", pro: "Phone + Chat + Email", enterprise: "24/7 Dedicated" } },
      { label: "Response SLA", values: { basic: "48 hours", premium: "12 hours", pro: "1 hour", enterprise: "15 minutes" } },
      { label: "Dedicated account manager", values: { basic: false, premium: false, pro: true, enterprise: true } },
    ],
  },
];
...
function PlanCard({
  ...
  return (
    <div
      className={`relative rounded-[2rem] p-6 sm:p-7 transition-all duration-300 flex flex-col text-zinc-900 ${
        featured
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <div className="text-xs text-black/60">{plan.tagline}</div>
        </div>
      </div>
