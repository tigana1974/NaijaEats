      ...
      <div className="py-4 sm:py-6 pb-24">
        ...
        <div className="mt-10">
          ...
          <div className="mt-5 rounded-3xl bg-card border border-border overflow-hidden">
            <div className="grid grid-cols-[minmax(150px,1.4fr)_repeat(3,1fr)] bg-muted/40 border-b border-border">
            ...
            {FEATURE_TABLE.map((section) => (
              <div key={section.section}>
                <div className="grid grid-cols-[minmax(150px,1.4fr)_repeat(3,1fr)] bg-muted/20 border-t border-border">
                ...
                {section.rows.map((row, i) => (
                  <div
                    key={row.label}
                    className={`grid grid-cols-[minmax(150px,1.4fr)_repeat(3,1fr)] ${
