...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DAzfj3Yb.mjs");
...
const manifest = {
  "f97d295818f3993990f59f82c6dcf65f6450fc19ef32de3d5b3781e7e51bf805": {
    functionName: "initiatePayment_createServerFn_handler",
    importer: () => import("./payments.functions-_I53i1Ox.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Ck7azls6.mjs").then((n) => n.r),
    import("./start-DPtgjeO_.mjs"),
