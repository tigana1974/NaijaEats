...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-gzKAxYbA.mjs");
...
const manifest = {
  "f97d295818f3993990f59f82c6dcf65f6450fc19ef32de3d5b3781e7e51bf805": {
    ...
    importer: () => import("./payments.functions-BlP2WBps.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-LlhGIoeI.mjs").then((n) => n.r),
    import("./start-BDiadNsP.mjs"),
